...
declare type BuildMode = 'readonly' | 'write-output';
...
export declare type WorkerMessage = WorkerDiagnosticsMessage | WorkerBuildMessage | WorkerStartMessage | WorkerDoneMessage;
