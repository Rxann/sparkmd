...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/constants.js
var require_constants = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/constants.js"(exports) {
    "use strict";
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/getBigInt.js
var require_getBigInt = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/getBigInt.js"(exports) {
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/Stats.js
var require_Stats = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/Stats.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/internal/buffer.js
var require_buffer = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/internal/buffer.js"(exports) {
    "use strict";
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/internal/errors.js
var require_errors = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/internal/errors.js"(exports) {
    "use strict";
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/encoding.js
var require_encoding = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/encoding.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/Dirent.js
var require_Dirent = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/Dirent.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/setImmediate.js
var require_setImmediate = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/setImmediate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var _setImmediate;
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/process.js
var require_process = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/process.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/node.js
var require_node = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/node.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/setTimeoutUnref.js
var require_setTimeoutUnref = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/setTimeoutUnref.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/promises.js
var require_promises = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/promises.js"(exports) {
    "use strict";
    var __spreadArray = exports && exports.__spreadArray || function(to, from, pack) {
      if (pack || arguments.length === 2)
        for (var i = 0, l = from.length, ar; i < l; i++) {
    ...
    function createPromisesApi(vol) {
      ...
      return {
        ...
        rm: function(path2, options) {
          return promisify(vol, "rm")(path2, options);
        },
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/volume.js
var require_volume = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/volume.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    function pathToFilename(path2) {
      if (typeof path2 !== "string" && !buffer_1.Buffer.isBuffer(path2)) {
        try {
          if (!(path2 instanceof require("url").URL))
    ...
    var Volume = function() {
      ...
      Volume2.prototype._toJSON = function(link, json, path2) {
        var _a2;
        if (link === void 0) {
          link = this.root;
        }
      ...
      Volume2.prototype.open = function(path2, flags, a, b) {
        var mode = a;
        var callback = b;
      ...
      Volume2.prototype.symlink = function(target, path2, a, b) {
      ...
      Volume2.prototype.realpath = function(path2, a, b) {
      ...
      Volume2.prototype.lstat = function(path2, a, b) {
      ...
      Volume2.prototype.stat = function(path2, a, b) {
      ...
      Volume2.prototype.access = function(path2, a, b) {
        var mode = F_OK;
        var callback;
        if (typeof a !== "function") {
          mode = a | 0;
      ...
      Volume2.prototype.readdir = function(path2, a, b) {
      ...
      Volume2.prototype.readlink = function(path2, a, b) {
      ...
      Volume2.prototype.mkdir = function(path2, a, b) {
      ...
      Volume2.prototype.mkdirp = function(path2, a, b) {
      ...
      Volume2.prototype.rmdir = function(path2, a, b) {
      ...
      Volume2.prototype.rm = function(path2, a, b) {
      ...
      Volume2.prototype.watchFile = function(path2, a, b) {
        var filename = pathToFilename(path2);
        var options = a;
        var listener = b;
...
// ../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/index.js
var require_lib = __commonJS({
  "../../node_modules/.pnpm/memfs@3.4.7/node_modules/memfs/lib/index.js"(exports, module2) {
    "use strict";
...
// ../../node_modules/.pnpm/unionfs@4.4.0/node_modules/unionfs/lib/union.js
var require_union = __commonJS({
  "../../node_modules/.pnpm/unionfs@4.4.0/node_modules/unionfs/lib/union.js"(exports) {
    "use strict";
      ...
      return new Proxy({}, {
        get: function(_obj, property) {
          ...
          try {
            ...
            try {
              if (watchers_1_1 && !watchers_1_1.done && (_a2 = watchers_1.return))
                _a2.call(watchers_1);
            } finally {
              if (e_1)
                throw e_1.error;
          ...
          if (funcCallers.length) {
            return function() {
              ...
              try {
                ...
                try {
                  if (funcCallers_1_1 && !funcCallers_1_1.done && (_a3 = funcCallers_1.return))
                    _a3.call(funcCallers_1);
                } finally {
                  if (e_2)
                    throw e_2.error;
                }
    ...
    var Union = function() {
      function Union2() {
        ...
        this.existsSync = function(path2) {
          var e_9, _a3;
          try {
            for (var _b2 = __values(_this.fss), _c2 = _b2.next(); !_c2.done; _c2 = _b2.next()) {
              var fs = _c2.value;
            ...
            args[lastarg] = function(err, resArg) {
              ...
              if (resArg) {
                try {
                  ...
                  try {
                    if (resArg_1_1 && !resArg_1_1.done && (_a3 = resArg_1.return))
                      _a3.call(resArg_1);
                  } finally {
                    if (e_10)
                      throw e_10.error;
        ...
        this.readdirSync = function() {
          ...
          for (var i = _this.fss.length - 1; i >= 0; i--) {
            ...
            try {
              ...
              try {
                for (var _b2 = (e_11 = void 0, __values(fs.readdirSync.apply(fs, args))), _c2 = _b2.next(); !_c2.done; _c2 = _b2.next()) {
                  var res = _c2.value;
                  result.set(_this.pathFromReaddirEntry(res), res);
                }
              } catch (e_11_1) {
        ...
        this.readdirPromise = function() {
          ...
          return __awaiter(_this, void 0, void 0, function() {
            var lastError, result, i, fs, _a3, _b2, res, e_12_1, err_1;
            var e_12, _c2;
            return __generator(this, function(_d2) {
              switch (_d2.label) {
                ...
                case 9:
                  try {
                    if (_b2 && !_b2.done && (_c2 = _a3.return))
                      _c2.call(_a3);
                  } finally {
                    if (e_12)
                      throw e_12.error;
        ...
        this.createReadStream = function(path2) {
          var e_14, _a3;
          var lastError = null;
          try {
            for (var _b2 = __values(_this.fss), _c2 = _b2.next(); !_c2.done; _c2 = _b2.next()) {
              ...
              try {
                ...
                if (fs.existsSync && !fs.existsSync(path2)) {
                  throw new Error('file "' + path2 + '" does not exists');
                }
                var stream = fs.createReadStream(path2);
                if (!stream) {
        ...
        this.createWriteStream = function(path2) {
          var e_15, _a3;
          var lastError = null;
          try {
            for (var _b2 = __values(_this.fss), _c2 = _b2.next(); !_c2.done; _c2 = _b2.next()) {
              ...
              try {
                ...
                fs.statSync(path2);
                var stream = fs.createWriteStream(path2);
                if (!stream) {
                  throw new Error("no valid stream");
                }
        ...
        try {
          ...
          try {
            if (fsSyncMethods_1_1 && !fsSyncMethods_1_1.done && (_a2 = fsSyncMethods_1.return))
              _a2.call(fsSyncMethods_1);
          } finally {
            if (e_3)
              throw e_3.error;
          }
        ...
        try {
          ...
          try {
            if (fsAsyncMethods_1_1 && !fsAsyncMethods_1_1.done && (_b = fsAsyncMethods_1.return))
              _b.call(fsAsyncMethods_1);
          } finally {
            if (e_4)
              throw e_4.error;
          }
        ...
        try {
          ...
          try {
            if (fsPromisesMethods_1_1 && !fsPromisesMethods_1_1.done && (_c = fsPromisesMethods_1.return))
              _c.call(fsPromisesMethods_1);
          } finally {
            if (e_5)
              throw e_5.error;
          }
...
// ../../node_modules/.pnpm/unionfs@4.4.0/node_modules/unionfs/lib/index.js
var require_lib2 = __commonJS({
  "../../node_modules/.pnpm/unionfs@4.4.0/node_modules/unionfs/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
function createPartialMemoryBackedSystem() {
  ...
  const system = {
    ...
    createDirectory(path2) {
      import_memfs.fs.mkdirSync(path2);
    },
    deleteFile(path2) {
      if (import_memfs.fs.existsSync(path2))
        import_memfs.fs.unlinkSync(path2);
    },
    directoryExists(path2) {
      return unionfs.existsSync(path2);
    },
    fileExists(path2) {
      return unionfs.existsSync(path2);
    },
    getDirectories(path2) {
      return unionfs.readdirSync(path2, { encoding: "utf-8", withFileTypes: false });
    },
    getModifiedTime(path2) {
      if (!unionfs.existsSync(path2))
        return void 0;
      const stat = unionfs.statSync(path2);
      return stat.mtime;
    },
    getFileSize(path2) {
      if (!unionfs.existsSync(path2))
    ...
    readFile(path2, encoding = "utf-8") {
      if (!unionfs.existsSync(path2))
        return void 0;
      return unionfs.readFileSync(path2, { encoding });
    },
    setModifiedTime(path2, time) {
      import_memfs.fs.utimesSync(path2, time, time);
    },
    writeFile(path2, data, writeBOM) {
      import_memfs.fs.mkdirpSync((0, import_path2.dirname)(path2));
      import_memfs.fs.writeFileSync(path2, writeBOM ? "\uFEFF" + data : data);
    }
  };
  return system;
}
...
function startWorker(options, port) {
  ...
  const commandLine = import_typescript2.default.parseJsonConfigFileContent(config, import_typescript2.default.sys, basedir);
  const build = options.build ?? commandLine.options.composite ?? false;
  const { options: compilerOptions } = commandLine;
  if (compilerOptions.noEmit === void 0)
